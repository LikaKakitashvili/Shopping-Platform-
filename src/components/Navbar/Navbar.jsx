...
export default function Navbar() {
  ...
  if (location.pathname.startsWith("/women") || location.pathname === "/") {
    ...
    activeCategory = location.state?.category ? `/${location.state.category}` : null;
  }
    ...
    <header className="navbar">
      <nav className="navbar__nav">
        ...
        <div className="navbar__center">
          <Logo width={120} height={40} className="navbar__logo" />
        </div>
